...
const InfoTilPasientAvvisning = () => {
  return (
    <Expandable className="info-til" erApen={false} tittel="Se hva vi sier til pasienten" type="intern">
      <Undertittel className="info-til__title">Sykmeldingen kan dessverre ikke brukes</Undertittel>
      <Normaltekst className="info-til__paragraph">Beklager at vi må bry deg mens du er syk.</Normaltekst>
